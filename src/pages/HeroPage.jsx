...
const WHY = [
  {
    icon: Zap,
    title: "Fast & Simple",
    desc: "Designed for small retailers — no complex setup, start managing in minutes.",
  },
  {
    icon: ShieldCheck,
    title: "Secure",
    desc: "Advanced security keeps your store data safe and private.",
  },
  {
    icon: BarChart3,
    title: "Always Accurate",
    desc: "Every transaction updates inventory instantly — no manual counting.",
  },
];
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-50 via-white to-white pt-16 pb-24 px-6 md:px-16">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg text-slate-500 max-w-xl mx-auto mb-10 leading-relaxed">
            IMS gives small store owners a clean, fast way to track products,
            purchases, sales and expiry dates — all in one place.
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 text-sm sm:text-base max-w-md mx-auto">
              Powering your entire inventory workflow seamlessly
            </p>
          </div>
      ...
      <section className="py-20 px-6 md:px-16 bg-teal-600">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-teal-200 text-sm sm:text-base max-w-md mx-auto">
              Built from the ground up for small retailers who need simplicity,
              not complexity.
            </p>
          </div>
      ...
      <footer className="border-t border-slate-100 py-8 px-6 md:px-16 flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <p className="text-xs text-slate-400">
          © 2026 IMS Portal. All rights reserved.
        </p>
      </footer>
    </div>
  );
